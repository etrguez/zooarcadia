...
<main class="container my-5">
    <h2 class="text-center text-success mb-4">Espace Vétérinaire</h2>
    <?php if(isset($_SESSION['message_connexion'])): ?>
        <div class="alert alert-info">
            <?php echo  htmlspecialchars($_SESSION['message_connexion']); ?>
        </div>
        <?php unset($_SESSION['message_connexion']); ?>
    <?php endif; ?>

    <div class="list-group">
        <a href="gestion_habitat.php" class="list-group-item list-group-item-action">Laisser un commentaire sur un habitat</a>
        <a href="rapport_veterinaire.php" class="list-group-item list-group-item-action">Faire un rapport vétérinaire</a>
    </div>
</main>
