...
<head>
    ...
    <title>Page des Habitats</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="https://stackdata.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
...
<nav class="navbar navbar-expand-lg bg-body-tertiary p-3" id="menu">
    ...
    <main>
        <section class="habitats d-flex flex-wrap justify-content-start justify-content-lg-around my-5">
            <?php
            if ($stmt->rowCount() > 0) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo '<img src="data:image/jpeg;base64,' . $imageData . '" class="card-img-top img-fluid" alt="..." >';
                    echo '<div class="card-body">';
                    echo '<h5 class="card-title text-success">' . ($row['nom']) . '</h5>';
                    echo '<p class="card-text">' . ($row['description']) . '</p>';
                    echo '</div>';
                    echo '<p><a class="text-success d-flex justify-content-center" href="detail_habitat.php?habitat_id=' . $row['habitat_id'] . '">Dècouvrir les pensionnaires.</a></p>';
                    echo '</div>';
                }
            } else {
